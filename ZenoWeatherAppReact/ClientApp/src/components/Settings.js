        ...
        <div className="d-block pageParentDiv" id="settingsContainer">
            ...
            <Form>
                <FormGroup className="settingsDiv">
                    ...
                    <input type="password" defaultValue={apiKey} className="form-control" id="exampleInputPassword1"
                        placeholder="API Key" runat="server" style={{ maxWidth: 400 + 'px' }} onKeyUp={() => setApiKey($('#exampleInputPassword1').val())}></input>
                </FormGroup>
            </Form>
            <div className="settingsDiv">
